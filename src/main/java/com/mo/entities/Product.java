...
public class Product {
	...
	public Product(UUID product_id, Long amount, String transaction_reason, String phone_number, String customer_name,
			String customer_email, String langague, String description, String currency, String payment_type) {
		super();
